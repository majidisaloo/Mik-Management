                                    ...
                                    {isRangeExpanded && (
                                      <div className="mt-3 p-3 bg-surface-secondary rounded">
                                        ...
                                        <div className="mt-4 p-3 bg-surface-secondary rounded">
                                          <h5 className="font-medium text-primary mb-3">Range Analysis</h5>
                                          <div className="grid grid-cols-4 gap-4 text-center">
                                            <div>
                                              <div className="text-lg font-bold text-primary">256</div>
                                              <div className="text-xs text-tertiary">Total IPs</div>
                                            </div>
                                            <div>
                                              <div className="text-lg font-bold text-green-600">254</div>
                                            ...
                                            <div>
                                              ...
                                              <div className="text-xs text-tertiary">Free Ranges</div>
                                            </div>
                                          </div>
                                        </div>
                                        ...
                                        {/* Free IP Ranges */}
                                        <div className="mt-4">
                                          <h5 className="font-medium text-primary mb-2">Free IP Ranges</h5>
                                          <div className="space-y-2">
                                            <div className="p-2 bg-green-50 border border-green-200 rounded text-sm">
                                              <span className="font-medium text-green-800">Range 1:</span> 
                                              <span className="text-green-700"> 37.187.25.1 - 37.187.25.126 (126 IPs)</span>
                                            </div>
                                            <div className="p-2 bg-green-50 border border-green-200 rounded text-sm">
                                              <span className="font-medium text-green-800">Range 2:</span> 
                                              <span className="text-green-700"> 37.187.25.129 - 37.187.25.254 (126 IPs)</span>
                                            </div>
                                            <div className="p-2 bg-green-50 border border-green-200 rounded text-sm">
                                              <span className="font-medium text-green-800">Range 3:</span> 
                                              <span className="text-green-700"> 37.187.25.128 (1 IP)</span>
                                            </div>
                                          </div>
                                        </div>
                                        ...
                                        <div className="mt-4 flex gap-2">
                                          <button 
                                            ...
                                            onClick={() => {
                                              // TODO: Show IP details modal
                                              console.log('Show IP details for range:', range.id);
                                            }}
                                          >
                                            Show Details
                                          </button>
                                          <button 
                                            ...
                                            onClick={() => {
                                              // TODO: Show split range modal
                                              console.log('Split range:', range.id);
                                            }}
                                          >
                                            Split Range
                                          </button>
                                        ...
                                        {range.ips && range.ips.length > 0 && (
                                          <div className="mt-4">
                                            <h5 className="font-medium text-primary mb-2">Used IP Addresses ({range.ips.length})</h5>
                                            <div className="space-y-2">
